    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('openrouter_api_key', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('daily_cost_limit', models.DecimalField(decimal_places=4, default=10.0, max_digits=10)),
                ('monthly_cost_limit', models.DecimalField(decimal_places=4, default=300.0, max_digits=10)),
                ('preferred_model', models.CharField(default='switchpoint/openrouter-4b', max_length=100)),
